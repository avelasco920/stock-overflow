...
class ChartComponent extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (
      ...
      const intradayPrices = nextProps.companyStockPrices.intraday.prices;
      const intradayTime = nextProps.companyStockPrices.intraday.time;
      const dailyPrices = nextProps.companyStockPrices.daily.prices;
      const dailyTime = nextProps.companyStockPrices.daily.time;
