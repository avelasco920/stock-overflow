...
class ChartComponent extends React.Component {
  constructor(props) {
    ...
    this.state = {
      intradayPricePoints: (!companyStockData) ? [] : companyStockData.intraday.prices,
      intradayTimePoints: (!companyStockData) ? [] : companyStockData.intraday.time,
      dailyPricePoints: (!companyStockData) ? [] : companyStockData.daily.prices,
      dailyTimePoints: (!companyStockData) ? [] : companyStockData.daily.time,
      idxRange: idxRange,
      graphTimePoints: [],
      graphPricePoints: [],
      lastClosingPrice: "",
    ...
    this.timesWithinRange = this.timesWithinRange.bind(this);
    this.pricesWithinRange = this.pricesWithinRange.bind(this);
  ...
  componentWillMount() {
    ...
    this.props.fetchRealtimeIntradayData(symbol);
      ...
      // .then((res) => {
      //   debugger;
      //   const intradayPricePoints = this.props.chartData.symbol.intraday.prices;
      //   const intradayTimePoints = this.props.chartData.symbol.intraday.time;
      //   const idxRange = this.idxRange(intradayTimePoints, thisMorning);
      //   this.setState({
